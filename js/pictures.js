...
var generateComments = function (count) {
  ...
  for (var i = 0; i < count; i++) {
    pictureComments.push(getRandomElement(COMMENTS)); //Только в push надо передавать случайный элемент массива.
  }
...
var showBigPicture = function () {
  ...
  // // var socialCommentList = document.querySelector('.social__comments');
  // var commentItem = '<li class="social__comment"><img class="social__picture" src="img/avatar-' + getRandomInteger(1, 6) + '.svg" alt="Аватар комментатора фотографии"width="35" height="35"><p class="social__text">' + publications[0].comments + '</p></li>';
